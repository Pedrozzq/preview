...
(function () {
    ...
    // TODO: substitua pelo número de WhatsApp real da loja (formato: 55 + DDD + número).
        ...
        drawer.innerHTML =
            ...
            '<aside id="cart-drawer" class="fixed top-0 right-0 h-full w-full sm:w-[420px] bg-brand-dark border-l border-white/10 z-[95] flex flex-col translate-x-full transition-transform duration-300 ease-out shadow-2xl">' +
                ...
                '<div id="cart-footer" class="border-t border-white/10 px-6 py-5 space-y-4">' +
                    ...
                    '</div>' +
                    '<a id="cart-whatsapp-btn" href="#" target="_blank" rel="noopener" class="btn-venus-solid w-full bg-brand-gold hover:bg-brand-gold-dark text-black font-semibold py-4 rounded-sm transition-all duration-300 uppercase tracking-wider text-sm flex items-center justify-center gap-2">' +
                        '<i class="fa-brands fa-whatsapp text-lg"></i> Finalizar no WhatsApp' +
                    '</a>' +
    ...
    window.PrimeCart = { add: addItem, open: openDrawer, close: closeDrawer };
})();
